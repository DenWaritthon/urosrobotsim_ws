...
static const _ImuStatus_Request_type_support_symbol_names_t _ImuStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_interfaces, srv, ImuStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_interfaces, srv, ImuStatus_Request)),
  }
};
...
{
  return &::imu_interfaces::srv::rosidl_typesupport_cpp::ImuStatus_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, imu_interfaces, srv, ImuStatus_Request)() {
  return get_message_type_support_handle<imu_interfaces::srv::ImuStatus_Request>();
}
...
static const _ImuStatus_Response_type_support_symbol_names_t _ImuStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_interfaces, srv, ImuStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_interfaces, srv, ImuStatus_Response)),
  }
};
...
{
  return &::imu_interfaces::srv::rosidl_typesupport_cpp::ImuStatus_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, imu_interfaces, srv, ImuStatus_Response)() {
  return get_message_type_support_handle<imu_interfaces::srv::ImuStatus_Response>();
}
...
static const _ImuStatus_type_support_symbol_names_t _ImuStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_interfaces, srv, ImuStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_interfaces, srv, ImuStatus)),
  }
};
...
{
  return &::imu_interfaces::srv::rosidl_typesupport_cpp::ImuStatus_service_type_support_handle;
}
